<head>
    <title>Deutsche Schloesser | Admin</title>
    <link rel="stylesheet" href="css/admin/side-nav.css">
    <script type="text/javascript" src="js/jquery-1.12.4.min.js"></script>
    <script type="text/javascript" src="js/admin/sidenav.js"></script>
</head>
<div class="side-nav">
    <ul>
        <li><span>Mein Konto</span></li>
          <li><a class="navlinks admSection" id="myData"><i class="fa fa-fw fa-id-card"></i> Persönliche Angaben</a></li>

        <li><span>Meine Einträge</span></li>
